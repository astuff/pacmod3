...
/* #define PACMOD4_USE_BITS_SIGNAL */
...
/* #define PACMOD4_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (PACMOD4_USE_DIAG_MONITORS) and define below
