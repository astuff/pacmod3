...
/* #define PACMOD3_USE_BITS_SIGNAL */
...
/* #define PACMOD3_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (PACMOD3_USE_DIAG_MONITORS) and define below
